...
class TCPDF
{
    ...
    */
    ...
    /**
    * @var bool set to true when the input text is unicode (require unicode fonts)
    *
    * @since 2005-01-02
    * @access protected
    */
    ...
    */
    ...
    /**
     * @var bool true when inside html pre tag
     * @access protected
     *
    ...
    */
    ...
    /**
        ...
        *
        * @param bool $value set to true to print the page footer (default), false otherwise.
        * @access public
        */
    ...
    * @param bool $clip if true activate clipping mode (you must call StartTransform() before this function and StopTransform() to stop the clipping tranformation).
    * @access public
    *
    * @since 1.0
    ...
    * @param int $stretch stretch carachter mode: <ul><li>0 = disabled</li><li>1 = horizontal scaling only if necessary</li><li>2 = forced horizontal scaling</li><li>3 = character spacing only if necessary</li><li>4 = forced character spacing</li></ul>
    * @param bool $ishtml set to true if $txt is HTML content (default = false).
    ...
    * @param bool $fitbox If true scale image dimensions proportionally to fit within the ($w, $h) box.
    ...
    * @param bool $cell if true add a cMargin to the x coordinate
    * @access public
    *
    * @since 1.0
    * @see Cell()
    ...
    */
     ...
     * @param bool   $cell   if true add the default cMargin space to each Write (default false).
     * @param string $align  Allows to center or align the text. Possible values are:<ul><li>L : left align</li><li>C : center</li><li>R : right align</li><li>'' : empty string : left for LTR or right for RTL</li></ul>
     * @access public
     */
    ...
    *
    * @param bool $booklet true set the booklet mode on, fals eotherwise.
    ...
    * @param bool $point if true returns points, otherwise returns value in user's units
    *
    ...
    */
     ...
     * @param bool  $cell if true add the default cMargin space to each new line (default false).
     * @access protected
     */
            ...
            case 'img': {
                if (isset($tag['attribute']['src'])) {
                    ...
                    if (($tag['attribute']['src'][0] == '/') and ($_SERVER['DOCUMENT_ROOT'] != '/')) {
                        // Si el fichero extiste tal cual no editamos la ruta, ya que editarla puede hacer que en CLOUD no se pueda cargar la imagen.
                        if (!file_exists($tag['attribute']['src'])) {
                            $tag['attribute']['src'] = $_SERVER['DOCUMENT_ROOT'].$tag['attribute']['src'];
                        }
                    }
                    $tag['attribute']['src'] = urldecode($tag['attribute']['src']);
                    // Sólamente cambiamos la URL por la ruta, si el archivo resultante extiste, ya que en CLOUD puede que la ruta resultante no sea correcta.
                    if (file_exists(str_replace(K_PATH_URL, K_PATH_MAIN, $tag['attribute']['src']))) {
     ...
     * @param bool   $firstorlast if true do not print additional empty lines.
     * @param string $tag         HTML tag to which this space will be applied
     * @param bool   $closing     true if this space will be applied to a closing tag, false otherwise
     * @access protected
     */
