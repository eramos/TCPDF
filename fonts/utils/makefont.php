 ...
 * @param bool   $embedded Set to false to not embed the font, true otherwise (default).
    ...
    if ($embedded) {
        ...
        if (function_exists('gzcompress')) {
            ...
            if (!empty($cidtogidmap)) {
                ...
                echo 'CIDToGIDMap created and compressed ('.$cmp.")\n";
                $s .= '$ctg=\''.$cmp."';\n";
            }
        } else {
...
if (count($arg) >= 3) {
    ...
    echo "Usage: makefont.php <ttf/otf/pfb file> <afm/ufm file> <encoding> <patch>\n";
}
